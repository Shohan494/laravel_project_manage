...
@section('content')
    @if (! Auth::check())
        ...
        <p><img src="{{ asset('images/sampleimage.jpg') }}" /></p>
 
        <a class="btn btn-large btn-info" href={{url("/auth/register")}}>Sign Up</a>
 
        <p class="login">Already signed up? <a class="btn btn-large btn-info" href={{url("/auth/signin")}}>Login</a></p>
    @endif
